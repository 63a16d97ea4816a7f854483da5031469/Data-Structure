...
##Returns the index of the first occurrence of needle in haystack, or -1 if needle is not part of haystack.(KMP)
    ...
    public int findSum(String str,String subStr){
        //input validation
...
##Binary operation / Bit operations  --- The sum of two binary numbers
     ...
     public void binarSum(String a,String b){
     //input validation
...
Method 1:
    public void permuatation(int[] nums,int i,int n){
...
## Symmetric Tree
    ...
    public boolean isSymmSub(TreeNode p,TreeNode q){
        ...
        if(p!=null && q!=null) return (p.val==q.val)&&isSymmSub(p.right,q.left)&&isSymmSub(p.left,q.right);
