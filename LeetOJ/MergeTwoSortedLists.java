			...
			if (currFirst == null) {
				...
				while (currFirst != null) {
					...
					if (currSecond.val > currFirst.val) {
						...
						// if currFirst Next is not null, that means it is not
						// reach the rear.
						if (currFirst.next != null) {
							...
							break;
							// if the currFirst reaches the end of the List 1,
							// we need to insert the value into the list 1 now
						} else {
							ListNode newNode = new ListNode(currSecond.val);
						...
						// it means it is head, we need to add value from head
						// of list 1.
						if (prevFirst == null) {
							...
							newNode.next = currFirst;
							// leave the prevFirst pointer to null, do not
							// modify it. But modify the currFirst pointer.
							currFirst = newNode;

							// as the head is changed, we need to modified the
							// l1 accordingly
							l1 = newNode;
							...
							// if the insert position is not in the head, maybe
							// it is in the middle or in the end of list 1
						} else {
